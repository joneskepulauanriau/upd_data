...
async function startBot() {
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        // ID Grup GMP = 120363177930974800 ID WA Test = 120363401358668785
        ...
        if (recPengguna.success || senderJid.includes('120363401358668785@g.us') || senderJid.includes('120363177930974800@g.us') || senderNumber === authorizingUser) {
            ...
            if (msg.message.liveLocationMessage){
                await sock.sendMessage(senderJid, { text: `_*Live Location* tidak diizinkan. *Stop Sharing* dan kirim kembali lokasinya._` });
                return;
            }
            ...
            if (msg.message.locationMessage){
                ...
                console.log(`NO HP Pada ID Grup ${senderJid} adalah ${no_hp}`);
            ...
            if (menu.toLowerCase()===GMP_RANGKING_PEMAIN){
              ...
              delete userSessions[sender];
                ...
                // Baca Tabel Pengguna untuk mendapatkan id_pemain
                let no_hp='';
                if (senderJid.includes('120363177930974800@g.us') || senderJid.includes('120363401358668785@g.us')) {no_hp = senderPart.split('@')[0]} else {no_hp = senderNumber};
